...
<!--- cspell:ignore lagom --->
graph TD;
    A[Έρευνα: Αξιολογήσεις Μετά από Προπόνηση με Ρομπότ για Ασθενείς με Χρόνιο Εγκεφαλικό Επεισόδιο] --> B[Robotic Group (n=9)]
    A --> C[Sham Group (n=10)]
    
    subgraph Robotic Group
        B1[FAC (μέγ. 6)]
        B2[FMA (μέγ. 34)]
        B3[MAS (μέγ. 4)]
        B4[BBS (μέγ. 56)]
        B5[Χρονομέτρηση 10 mWT]
        B6[6MWT]
        ...
        B1 --> D1[Πριν: 4,8 (0,8)]
        B1 --> D2[Μετά: +0,6]
        B1 --> D3[Παρακολούθηση: +0,7]
        
        B2 --> E1[Πριν: 17,9 (4,6)]
        B2 --> E2[Μετά: +2,4 *]
        B2 --> E3[Παρακολούθηση: +2,4]
        
        B3 --> F1[Πριν: 1,4 (0,5)]
        B3 --> F2[Μετά: −0,2]
        B3 --> F3[Παρακολούθηση: −0,2]
        
        B4 --> G1[Πριν: 51,4 (5,1)]
        B4 --> G2[Μετά: +0,3]
        B4 --> G3[Παρακολούθηση: −0,8]
        
        B5 --> H1[Πριν: 0,72 (0,21)]
        B5 --> H2[Μετά: +0,07]
        B5 --> H3[Παρακολούθηση: +0,10]
        
        B6 --> I1[Πριν: 207,3 (59,7)]
        B6 --> I2[Μετά: +16,9]
        B6 --> I3[Παρακολούθηση: +41,5]
    end
    ...
    subgraph Sham Group
        ...
        C1 --> J1[Πριν: 4,5 (0,8)]
        C1 --> J2[Μετά: +0,1]
        C1 --> J3[Παρακολούθηση: +0,3]
        
        C2 --> K1[Πριν: 16,1 (5,2)]
        C2 --> K2[Μετά: +1,0]
        C2 --> K3[Παρακολούθηση: +1,3]
        
        C3 --> L1[Πριν: 1,7 (0,6)]
        C3 --> L2[Μετά: −0,1]
        C3 --> L3[Παρακολούθηση: −0,2]
        
        C4 --> M1[Πριν: 47,6 (5,4)]
        C4 --> M2[Μετά: −0,2]
        C4 --> M3[Παρακολούθηση: −0,4]
        
        C5 --> N1[Πριν: 0,52 (0,37)]
        C5 --> N2[Μετά: +0,01]
        C5 --> N3[Παρακολούθηση: +0,00]
        
        C6 --> O1[Πριν: 141,6 (91,2)]
        C6 --> O2[Μετά: +5,7]
        C6 --> O3[Παρακολούθηση: +22,2]
    end
